...
<h1 class="app-page-title">Sửa mã giảm giá </h1>
	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" action="?act=ma-giam-gia-update&id=<?= $id_magg?>" method="post" enctype="multipart/form-data" >
								    <!-- <div class="mb-3">
  ...
  <circle cx="8" cy="4.5" r="1"/>
									...
									<button type="submit" class="btn app-btn-primary" name="submit" >Sửa mã giảm giá</button>
							    </form>
						    </div><!--//app-card-body-->
