...
<head>
	...
	<!-- FontAwesome JS-->
	<script defer src="Views/assets/plugins/fontawesome/js/all.min.js"></script>

	<!-- App CSS -->

	<link id="theme-style" rel="stylesheet" href="Views/assets/css/portal.css">
</head>
						...
						<div class="app-utilities col-auto">
							...
							<div class="app-utility-item app-user-dropdown dropdown">
								<a class="dropdown-toggle" id="user-dropdown-toggle" data-bs-toggle="dropdown" href="#"
									role="button" aria-expanded="false"><img src="Views/assets/images/user.png"
										alt="user profile"></a>
		...
		<div id="app-sidepanel" class="app-sidepanel">
			...
			<div class="sidepanel-inner d-flex flex-column">
				...
				<div class="app-branding">
					<a class="app-logo" href="index.html"><img class="logo-icon me-2" src="Views/assets/images/app-logo.svg"
...
<!-- DANH MUC -->
						<li class="nav-item has-submenu">
							...
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link submenu-toggle" href="?act=danh-muc-list" data-bs-toggle="collapse"
							...
							<div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link"
											href="?act=danh-muc-list">Danh sách</a></li>
									<li class="submenu-item"><a class="submenu-link" href="?act=danh-muc-add">Thêm mới</a>
									</li>
								</ul>
							</div>
						</li><!--//nav-item-->
<!-- SAN PHAM -->
						<li class="nav-item has-submenu">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link submenu-toggle" href="?act=san-pham-list" data-bs-toggle="collapse"
							...
							<div id="submenu-2" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link"
											href="?act=san-pham-list">Danh sách</a></li>
									<li class="submenu-item"><a class="submenu-link" href="?act=san-pham-add">Thêm mới</a>
									</li>
								</ul>
							</div>
						</li><!--//nav-item-->
<!-- Biến thể -->
						<li class="nav-item has-submenu">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link submenu-toggle" href="?act=bien-the-list" data-bs-toggle="collapse"
								...
								<span class="nav-link-text">Biến thể</span>
								<span class="submenu-arrow">
									<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down"
										fill="currentColor" xmlns="http://www.w3.org/2000/svg">
										<path fill-rule="evenodd"
							...
							<div id="submenu-3" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link"
											href="?act=bien-the-list">Danh sách</a></li>
									<li class="submenu-item"><a class="submenu-link" href="?act=bien-the-add">Thêm mới</a>
									</li>
								</ul>
							</div>
						</li><!--//nav-item-->
<!-- Liên hệ -->
						<li class="nav-item has-submenu">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link submenu-toggle" href="?act=lien-he-list" data-bs-toggle="collapse"
...
<!-- KHACH HANG -->
						<li class="nav-item has-submenu">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link submenu-toggle" href="?act=khach-hang-list" data-bs-toggle="collapse"
							...
							<div id="submenu-5" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link"
											href="?act=khach-hang-list">Danh sách</a></li>
									<li class="submenu-item"><a class="submenu-link" href="?act=khach-hang-add">Thêm mới</a>
									</li>
								</ul>
							</div>
						</li><!--//nav-item-->
<!-- MA GIAM GIA -->
						<li class="nav-item has-submenu">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link submenu-toggle" href="?act=ma-giam-gia-list" data-bs-toggle="collapse"
							...
							<div id="submenu-6" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link"
											href="?act=ma-giam-gia-list">Danh sách</a></li>
									<li class="submenu-item"><a class="submenu-link" href="?act=ma-giam-gia-add">Thêm mới</a>
									</li>
								</ul>
							</div>
						</li><!--//nav-item-->
<!-- Quản Lý Hóa Đơn -->
						<li class="nav-item has-submenu">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link submenu-toggle" href="?act=quan-ly-hoa-don-list" data-bs-toggle="collapse"
								data-bs-target="#submenu-7" aria-expanded="false" aria-controls="submenu-1">
								<span class="nav-icon">
									<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
									<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-files"
										fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
<!-- Slide -->
						<li class="nav-item has-submenu">
							<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
							<a class="nav-link submenu-toggle" href="?act=slider-list" data-bs-toggle="collapse"
							...
							<div id="submenu-8" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
								<ul class="submenu-list list-unstyled">
									<li class="submenu-item"><a class="submenu-link"
											href="?act=slider-list">Danh sách</a></li>
									<li class="submenu-item"><a class="submenu-link" href="?act=slider-add">Thêm mới</a>
									</li>
								</ul>
							</div>
						</li><!--//nav-item-->
