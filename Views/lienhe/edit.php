...
<h1 class="app-page-title">Thêm liên hệ</h1>
	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" action="?act=san-pham-post" method="post" enctype="multipart/form-data" >
								    <div class="mb-3">
  ...
  <circle cx="8" cy="4.5" r="1"/>
								    ...
								    <div class="mb-3">
									    ...
									    <input type="text" class="form-control" id="setting-input-2" name="moTa" placeholder="Mô tả sản phẩm" value="<?= isset($moTa) ? $moTa:''  ?>">
										<span class="text-danger"><?php 
                                        echo isset($error['moTa']) ? $error['moTa'] : '';
                                        ?></span>
									</div>
								    <div class="mb-3">
									    <label for="setting-input-3" class="form-label">Tin nhắn</label>
									    <input type="text" class="form-control" id="setting-input-2" name="chatLieu" placeholder="Chất liệu sản phẩm" value="<?= isset($chatLieu) ? $chatLieu:''  ?>">
										<span class="text-danger"><?php 
                                        echo isset($error['chatLieu']) ? $error['chatLieu'] : '';
                                        ?></span>
									</div>
								>
									<button type="submit" class="btn app-btn-primary" name="submit" >Thêm liên hệ</button>
							    </form>
						    </div><!--//app-card-body-->
