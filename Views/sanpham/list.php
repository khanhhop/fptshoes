							        ...
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												...
												<th class="cell">Giá sản phẩm</th>
												<th class="cell">Mô tả</th>
												<th class="cell">Chất liệu</th>
										...
										<tbody>
                                            <?php foreach($listSP as $sanPham){
                                             ...
                                             ?>
											<tr>
												<td class="cell"><?= $id_sp ?></td>
							                    <td class="cell"><?= $ten_sp?></td>
												<td class="cell"><a href="<?=$anh?>"><img src="./image/<?=$anh?>" alt="ảnh" style="max-width: 70px; height: 70px;"></a></td>
                                                <td class="cell"><?= $ten_dm ?></td>
												<td class="cell"><?= $gia?></td>
												<td class="cell"><?= $mo_ta?></td>
